...
(0, mocha_1.describe)('generateContrastColors', function () {
    (0, mocha_1.it)('should work', function () {
    ...
    (0, mocha_1.it)('should correctly parse known named colors', function () {
    ...
    (0, mocha_1.it)('should correctly parse short hex colors', function () {
    ...
    (0, mocha_1.it)('should correctly parse hex colors', function () {
    ...
    (0, mocha_1.it)('should correctly parse RGB tuple string', function () {
    ...
    (0, mocha_1.it)('should correctly parse RGBA tuple string', function () {
...
(0, mocha_1.describe)('gradientColorAtPercent', function () {
    (0, mocha_1.it)('0%', function () {
