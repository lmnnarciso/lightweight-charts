...
(0, mocha_1.describe)('formatDate', function () {
    var date = new Date('1990-04-24');
    var locale = 'en-US';
    (0, mocha_1.it)('should correct handle yyyy sequence', function () {
    ...
    (0, mocha_1.it)('should correct handle yy sequence', function () {
    ...
    (0, mocha_1.it)('should correct handle yyyy and yy sequences', function () {
    ...
    (0, mocha_1.it)('should correct handle MMMM sequence', function () {
    ...
    (0, mocha_1.it)('should correct handle MMM sequence', function () {
    ...
    (0, mocha_1.it)('should correct handle MM sequence', function () {
    ...
    (0, mocha_1.it)('should correct handle MMMM, MMM and MM sequences', function () {
    ...
    (0, mocha_1.it)('should correct handle dd sequence', function () {
    ...
    (0, mocha_1.it)('should ignore non-sequences', function () {
