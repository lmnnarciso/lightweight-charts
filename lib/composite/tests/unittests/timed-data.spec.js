...
function visibleTimedValuesCase(rangeFrom, rangeTo, extendedRange, expectedFrom, expectedTo, times) {
    ...
    var actual = (0, time_data_1.visibleTimedValues)(timedData, barsRange, extendedRange);
    var expected = { from: expectedFrom, to: expectedTo };
    (0, chai_1.expect)(actual).to.be.deep.equal(expected);
}
(0, mocha_1.describe)('TimedData', function () {
    (0, mocha_1.it)('visibleTimedValues', function () {
    ...
    (0, mocha_1.it)('visibleTimedValues with exteded range', function () {
